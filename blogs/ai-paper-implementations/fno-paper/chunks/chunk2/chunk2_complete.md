...
## 🖼️ Key Visual: Understanding Fourier Transform
...
## 🖼️ Key Visual: Fourier Series Approximation
...
3. For global receptive field: kernel size = input size → $O(N^2)$ complexity
...
The FNO paper states: *"We therefore propose to directly parameterize $\kappa_\phi$ in Fourier space."*
...
**This is it.** FFT → Multiply by learned weights → IFFT. That's the core operation.

---

## 🖼️ Key Visual: FNO Architecture (from Original Paper)
...
## 🖼️ Generated Figure 1: Basic 1D Spectral Convolution
...
## 🖼️ Key Visual: Time vs Frequency Domain
...
## 🖼️ Key Visual: 2D FFT for Image Processing
...
## 🖼️ Generated Figure 2: 2D Mode Truncation
...
## 🖼️ Key Visual: Complex Numbers in Fourier Space
...
## 🖼️ Key Visual: Low-pass vs High-pass Filtering
...
## 🖼️ Generated Figure 3: Why Both Paths Matter
...
## 🖼️ Key Visual: Activation Functions
...
## 🖼️ Generated Figure 4: Activation Functions
...
## 🖼️ Key Visual: The Complete Fourier Layer Pipeline
...
## 🖼️ Key Visual: Resolution Independence Concept
...
## 🖼️ Generated Figure 5: Resolution Invariance
...
## 🖼️ Generated Figure 6: Stacked Layers Progressive Transformation
...
# 🖼️ External Image Credits Summary
